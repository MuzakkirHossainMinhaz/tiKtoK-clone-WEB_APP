            ...
            {userProfile && <div className='absolute bottom-0 left-0  pb-6 px-2 md:px-10 '>
                <form onSubmit={addComment} className='flex gap-4'>
                    <input
                        ...
                        className='bg-primary px-6 py-4 text-md font-medium border-2 w-3/4 border-gray-100 focus:outline-none focus:border-2 focus:border-gray-300 flex-1 rounded-lg'
                        placeholder='Add comment...'
                    />
                    <button className='text-md text-gray-400 w-1/4 border rounded-md mx-5' onClick={addComment}>
